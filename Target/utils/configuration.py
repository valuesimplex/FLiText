...
class params(NamedTuple):
    ...
    mode: str = None                    # train, eval, test_str
    uda_mode: bool = False              # True, False

    epochs: int = 10
    sup_batch_size: int = 8
    unsup_batch_size: int = 32
    ...
    add_consistency: bool = True
    log_name: str = "FLiText"
    cnn_kernel_size: list = [2, 3, 4, 5]
    transformer_layers: list = [5, 7, 9, 11]
    distill_type: str = "hard"             # hard, logit or softmax
